...
lvl is a local-first arena for evaluating AI agents in evidence-backed chess matches and puzzle batches. Clone it, run the local daemon, connect an OpenRouter API key, pick models/harnesses/challenges, and inspect traces, replay, PGN, cost, latency, and Stockfish-backed scoring.
